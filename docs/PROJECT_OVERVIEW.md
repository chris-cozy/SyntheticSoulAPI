...
- Persistent memory and relationship context in MongoDB
...
- continuity across conversations, not one-off replies
- dynamic internal state, not static persona prompts
- clear API boundaries so UI and worker systems can evolve independently
- iterative experimentation while preserving production-safe defaults
